...
load("//tools/release/wails/private:assets.bzl", _wails_asset_library = "wails_asset_library", _wails_asset_provider = "wails_asset_provider")
...
wails_asset_provider = _wails_asset_provider
