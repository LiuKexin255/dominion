...
func (w *MongoDBWorkload) ResourceName() string {
	...
	return newObjectName(WorkloadKindMongoDB, w.EnvironmentName, w.App, w.ServiceName)
}
...
func (w *MongoDBWorkload) SecretResourceName() string {
	...
	return newObjectName(WorkloadKindSecret, w.EnvironmentName, w.App, w.ServiceName)
}
...
func (w *MongoDBWorkload) PVCResourceName() string {
	...
	return newObjectName(WorkloadKindPVC, w.EnvironmentName, w.App, w.ServiceName)
}
