...
<!--
  ACTION REQUIRED: Every external fact, design decision, API specification,
  or technical detail cited anywhere in this spec MUST appear here with a
  traceable link. If no external material is cited, keep the section and
  write "No external references."
