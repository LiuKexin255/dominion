...
// Resolve lists EndpointSlices for the resolved Service and expands them into stable ip:port addresses.
...
func expandEndpointSliceAddresses(endpointSlices []discoveryv1.EndpointSlice, port int) []string {
