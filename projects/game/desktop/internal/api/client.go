...
func (c *Client) CreateSession() (*game.Session, error) {
	body, err := protojson.Marshal(new(game.CreateSessionRequest))
	if err != nil {
		return nil, fmt.Errorf("create session: %w", err)
	}

	req, err := http.NewRequestWithContext(context.Background(), http.MethodPost, c.url("/api/v1/sessions"), bytes.NewReader(body))
	if err != nil {
		return nil, fmt.Errorf("create session: %w", err)
	}
...
func (c *Client) GetSession(sessionID string) (*game.Session, error) {
...
func (c *Client) CreateAgent(sessionID string) (*game.Agent, error) {
	...
	req, err := http.NewRequestWithContext(context.Background(), http.MethodPost, c.url("/api/v1/sessions/"+sessionID+"/agent"), bytes.NewReader(body))
	if err != nil {
		return nil, fmt.Errorf("create agent: %w", err)
	}
	c.setCommonHeaders(req)
...
func (c *Client) GetAgent(sessionID string) (*game.Agent, error) {
...
func (c *Client) GetAgentStatus(sessionID string) (*game.AgentStatus, error) {
	req, err := http.NewRequestWithContext(context.Background(), http.MethodGet, c.url("/api/v1/agents/"+sessionID+"/status"), nil)
	if err != nil {
