/**
 * cordis plugin entry for the memory plugin's model-facing face — the row the
 * planner preset's composition mounts
 ...
 * specs/064-memory-split-fold-remain/contracts/dsh-plugins.md §1/§2). It
