...
| 层 | 内容 | 归属 |
|---|---|---|
| 框架核心底座 | ≈11 包（app-boot + cordis 家族 loader/include/group/timer + node-addon-require-builtin + home-paths/invariants/system-prompt/launch-environment），精确 pin 0.1.1-rc.2 线 | `third_party/dsh/core:runtime_pkg`（**零插件**，底座包内直接 pin） |
