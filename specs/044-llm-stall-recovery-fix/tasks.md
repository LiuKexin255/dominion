...
- T011 ∥ T018 ∥ T019 —— 不同文件（`agent_stall_test.go` / `system_test.yaml` / fake-llm `stall_recovery.yaml` + `message_store_test.go` pin 断言（2026-08-14 amendment）），Phase 5A 完成后可并行。
