...
require (
	...
	github.com/protoc-contrib/protoc-gen-go-aip v0.1.3
...
tool (
	github.com/protoc-contrib/protoc-gen-go-aip
	github.com/protoc-contrib/protoc-gen-go-aip/cmd/protoc-gen-go-aip
)
